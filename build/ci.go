...
func doInstall(cmdline []string) {
	...
	if runtime.Version() < "go1.7" && !strings.Contains(runtime.Version(), "devel") {
		...
		log.Println("go-ethersocial requires at least Go version 1.7 and cannot")
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/ethersocial/go-ethersocial/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/ethersocial/go-ethersocial/mobile")
